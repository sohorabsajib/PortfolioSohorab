    ...
    <section className="h-max md:h-screen bg-gradient-to-l bg-gray-950 text-white flex flex-col justify-center items-center relative z-10 pb-10">
      ...
      <div className="max-w-7xl mt-24 mx-auto items-center flex flex-col md:flex-row gap-16 md:gap-40 justify-between">
        <div className="md:space-y-6 px-4">
          ...
          >
            Hi👋, I'm <p className="text-blue-400">Sohorab Hossain</p>
          </motion.h1>
          <motion.p
            initial={{ opacity: 0, x: -100 }}
            whileInView={{ opacity: 1, x: 0 }}
          ...
          >
            A detail-oriented web developer with 3+ years of experience in
            creating responsive and user-friendly web applications. Proficient
            in front-end and back-end development, client communication, and
            project management. Passionate about designing scalable solutions
